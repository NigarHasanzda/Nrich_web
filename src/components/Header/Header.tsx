...
const Header = () => {
  ...
  return (
    <>
      <header className="w-full py-6 flex justify-center sticky top-0 bg-white z-50">
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[250px] bg-white z-50 shadow-lg transition-transform duration-300 flex flex-col p-6 ${
