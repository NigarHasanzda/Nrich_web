            ...
            return (
              ...
              >
                <div className="flex justify-between items-start md:items-center gap-4">
                  <h3
                    className={`text-[14px] md:text-[18px] leading-snug font-semibold transition-colors duration-300 ${
                ...
                >
                  <p className="text-[#6C757D] text-[12px] md:text-[16px] leading-[1.8] md:leading-[1.9] max-w-full md:max-w-[60%] font-normal">
                    {item.answer}
                  </p>
                </div>
              </div>
